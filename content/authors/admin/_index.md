...
role: Senior Undergrad in Computer Science
...
profiles:
  - icon: custom/envelope-regular-icon
    url: 'mailto:ethan.villalovoz@gmail.com'
    label: E-mail Me
  # - icon: brands/x
  ...
  - icon: brands/github
    url: https://github.com/ethanvillalovoz
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/evillalovoz27/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=CavKFp4AAAAJ&hl=en

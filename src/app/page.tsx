						...
						<div className="flex-1 space-y-6">
							...
							<div className="flex flex-col md:flex-row items-center gap-6 pt-2">
								...
								<div className="flex items-center gap-5">
									<a href="https://www.linkedin.com/in/ethanvillalovoz/" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-foreground transition-all duration-300 ease-in-out hover:-translate-y-1">
										<FaLinkedin size={22} />
									</a>
									...
									<a href="https://x.com/ethanvillalovoz" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-foreground transition-all duration-300 ease-in-out hover:-translate-y-1">
										<FaXTwitter size={22} />
									</a>

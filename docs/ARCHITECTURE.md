...
The secondary route group adds navigation and a footer to Research without adding either element to Home.
...
Legacy `/writing/`, `/work/`, `/projects/`, `/publications/`, `/teaching/`, `/DreamWorlds/`, and `/gaussian-splatting-physics/` paths redirect to Research.
...
- Research publishes publication and project structured data.
- Home and Research define canonical URLs at the route level.
